...
import { BedDouble, UserPlus, Users, UserCheck, Search } from "lucide-react";
...
const ipdNav = [
  ...
  },
  {
    ...
    path: "/ipd/admitted",
    icon: Users,
    description: "View all currently admitted",
    color: "blue",
  },
  {
    label: "Released Patients",
    path: "/ipd/released",
    icon: UserCheck,
    description: "Browse discharged records",
    color: "violet",
  },
  {
