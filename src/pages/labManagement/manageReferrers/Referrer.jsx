    ...
    <div className="group relative bg-white rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.02),0_4px_12px_rgba(0,0,0,0.01)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.04)] transition-all duration-300 p-5 border border-gray-100/80 hover:border-blue-200">
      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start gap-4">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 text-blue-700 font-semibold text-base tracking-tight shadow-sm ring-1 ring-black/5 group-hover:shadow transition-all duration-300">
        ...
        <div className="flex flex-row items-center gap-2 shrink-0 flex-wrap mx-auto lg:mx-0">
          <button
            onClick={onEdit}
            className="px-4 py-2 rounded-lg text-xs font-medium bg-white text-gray-700 border border-blue-300 hover:bg-blue-50 hover:border-blue-400 hover:text-blue-700 transition-all duration-200 inline-flex items-center justify-center gap-1.5 shadow-sm hover:shadow [&>svg]:text-gray-700 hover:[&>svg]:text-blue-700"
          >
          ...
          {input.isActive ? (
            <button
              ...
              className="px-4 py-2 rounded-lg text-xs font-medium bg-white text-gray-700 border border-amber-300 hover:bg-amber-50 hover:border-amber-400 hover:text-amber-700 transition-all duration-200 inline-flex items-center justify-center gap-1.5 shadow-sm hover:shadow [&>svg]:text-gray-700 hover:[&>svg]:text-amber-700"
            >
            ...
            <button
              onClick={onActivate}
              className="px-4 py-2 rounded-lg text-xs font-medium bg-white text-gray-700 border border-emerald-300 hover:bg-emerald-50 hover:border-emerald-400 hover:text-emerald-700 transition-all duration-200 inline-flex items-center justify-center gap-1.5 shadow-sm hover:shadow [&>svg]:text-gray-700 hover:[&>svg]:text-emerald-700"
            >
          ...
          <button
            onClick={onDelete}
            className="px-4 py-2 rounded-lg text-xs font-medium bg-white text-gray-700 border border-rose-300 hover:bg-rose-50 hover:border-rose-400 hover:text-rose-600 transition-all duration-200 inline-flex items-center justify-center gap-1.5 shadow-sm hover:shadow [&>svg]:text-gray-700 hover:[&>svg]:text-rose-600"
          >
