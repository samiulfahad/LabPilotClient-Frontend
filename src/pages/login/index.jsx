...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <div
        className="fixed top-4 right-4 z-50 flex items-center gap-1.5 bg-white/80 backdrop-blur border border-gray-100 rounded-xl px-3 py-2 shadow-sm"
        style={{
          opacity: mounted ? 1 : 0,
      ...
      >
        ...
        <div
          className="flex items-center gap-3 px-5 py-4 rounded-t-3xl border-b border-slate-200"
          style={{
        ...
        >
          <div className="px-7 pt-6 pb-6">
            ...
            {view === "login" && (
              <div className="mb-5" style={{ animation: "lpFadeUp 0.5s cubic-bezier(.22,1,.36,1) 0.1s both" }}>
                <h1
                  className="text-[22px] font-black text-gray-900 tracking-tight leading-tight mb-0.5"
                  style={{ letterSpacing: "-0.03em" }}
                >
                  Welcome back<span className="text-blue-600">.</span>
                </h1>
                <p className="text-[13px] text-gray-400 font-light">Sign in to access your lab workspace</p>
              </div>
            )}
            ...
            {view === "reset" && (
              <div className="mb-5" style={{ animation: "lpFadeUp 0.5s cubic-bezier(.22,1,.36,1) 0.1s both" }}>
                ...
                <p className="text-[13px] text-gray-400 font-light">We'll send a secure link to your phone</p>
              </div>
            )}
            ...
            {view === "sent" && (
              <div className="mb-5" style={{ animation: "lpFadeUp 0.5s cubic-bezier(.22,1,.36,1) 0.1s both" }}>
                ...
                <p className="text-[13px] text-gray-400 font-light">Instructions sent successfully</p>
              </div>
            )}
            ...
            {view === "login" && (
              <div className="flex flex-col gap-4">
                ...
                {loginError && (
                  <div
                    className="flex items-center gap-2 px-3 py-2.5 rounded-xl text-[12.5px] text-red-600 font-medium bg-red-50 border border-red-200"
                    style={{ animation: "lpFadeUp 0.25s cubic-bezier(.22,1,.36,1) both" }}
                  >
                    <AlertCircle size={13} />
                    {loginError}
                ...
                <div className="mt-1" style={{ animation: "lpFadeUp 0.5s cubic-bezier(.22,1,.36,1) 0.32s both" }}>
                  <button
                    ...
                    onClick={handleLogin}
                    disabled={loading}
                    className="group w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl font-semibold text-sm text-white transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/25 active:translate-y-0"
                    style={{
            ...
            {view === "reset" && (
              ...
              >
                ...
                <button
                  ...
                  onClick={handleReset}
                  disabled={loading}
                  className="group w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl font-semibold text-sm text-white transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/25"
                  style={{
                    background: "linear-gradient(135deg, #2563eb 0%, #4f46e5 100%)",
                    boxShadow: "0 4px 16px rgba(37,99,235,0.28)",
                  }}
            ...
            {view === "sent" && (
              ...
              >
                ...
                <div className="text-center space-y-1">
                  <p className="text-[13.5px] text-slate-500">Reset link sent to</p>
          ...
          <div className="flex items-center justify-between px-7 py-3 rounded-b-3xl border-t border-gray-100 bg-gray-50/50">
